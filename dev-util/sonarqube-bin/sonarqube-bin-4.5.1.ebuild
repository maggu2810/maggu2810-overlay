...
src_install() {
	...
	cp "${FILESDIR}/sonar-64.service" "sonar-64.service"
	cp "sonar-64.service" "sonar-32.service"
	sed s:linux-x86-64:linux-x86-32:g -i sonar-32.service
	systemd_newunit sonar-64.service sonar-64.service
	systemd_newunit sonar-32.service sonar-32.service
