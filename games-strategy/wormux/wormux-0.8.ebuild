...
# $Header: $
# This ebuild come from http://bugs.gentoo.org/show_bug.cgi?id=154041  - The site http://gentoo.zugaina.org/ only host a copy.
...
RDEPEND=">=dev-cpp/libxmlpp-2.6
	...
	jpeg? ( media-libs/sdl-image )
	png? ( media-libs/sdl-image )
	>=media-libs/sdl-mixer-1.2
	vorbis? ( media-libs/sdl-mixer )
