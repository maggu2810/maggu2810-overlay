...
IUSE="debug glibc-omitfp glibc-compat20 hardened multilib nls selinux profile
vanilla ${LT_VER:+glibc-compat20 nptl nptlonly} memmovepatch"
...
eblit-src_unpack-post() {
	...
	use memmovepatch && epatch "${FILESDIR}"/2.7/glibc-2.7-memmove-redefinition.patch
}
