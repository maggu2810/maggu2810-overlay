...
# $Header: /var/lib/cvsd/root/portage/x11-libs/wxGTK/wxGTK-2.6.3.3.ebuild,v 1.1 2006/12/30 15:38:30 oliver Exp $
...
src_unpack() {
	...
	epatch "${FILESDIR}/${P}-darknrg_close_tab_fix.patch"
